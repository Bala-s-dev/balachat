    ...
    try {
      ...
      list.forEach((person) => {
        if (person._id === user.id)
          return toast.info('You are added automatically');
        if (members.find((m) => m._id === person._id))
          return toast.info(`${person.username} already added`);
        ...
        <div>
          ...
          >
            ...
            {members.length === 0 && (
              ...
              >
                Search and add participants above
              </p>
            )}
          </div>
        </div>
