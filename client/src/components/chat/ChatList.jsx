        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <div style={{ position: 'relative' }} ref={menuRef}>
              ...
              >
                <Avatar src={user?.avatar} name={user?.username} size={26} />
              </button>
              {showMenu && (
                <div
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        {loadingChats ? (
          ...
          <EmptyState
            ...
            desc={
              search ? 'Try a different name' : 'Start a conversation above'
            }
          />
        ) : (
          <div className="stagger">
            {filtered.map((chat) => {
              const chatId = chat.chatId || chat._id;
              const isActive =
                activeChat && (activeChat.chatId || activeChat._id) === chatId;
              const name = chat.isGroup ? chat.name : chat.receiverUsername;
              const isOnline =
                !chat.isGroup && onlineUsers.includes(chat.receiverId);
